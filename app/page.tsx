...
//           >
//             <source src="/videos/earth(1).mp4" type="video/mp4" />
//           </video>
//           <AnimatedGradient />
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="relative z-50 bg-black border-b border-white/20">
        <div className="container mx-auto flex h-20 items-center justify-between px-4">
          ...
          <div className="relative flex items-center justify-center">
            <div className="border-2 border-white bg-black px-4 py-3 flex gap-10 rounded-none">
              {["Pricing", "Docs", "Developers", "Contact"].map(
                (label, idx) => {
                  const items = [
                    {
                      label: "Pricing",
                  ...
                  const { href, description, image } = items[idx];
                  return (
                    <div
                      key={label}
                      className="relative group flex flex-col items-center"
        ...
        <section className="relative w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-b from-background to-muted/30 overflow-hidden">
          ...
          <div className="container relative z-10 px-4 md:px-6">
            ...
            <ScrollReveal className="mt-24 space-y-12" threshold={0.2}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[100, 200, 300].map((delay, idx) => (
                  <ScrollReveal key={idx} delay={delay}>
                    <FeatureCard>
                      <div className="text-sm text-muted-foreground">
                        {
                          [
                            "No more manual entry - parse financial data at scale with Invaro.",
                            "Integrate financial data parsing in minutes with our developer-friendly API.",
                            "Build smarter financial applications with clean, structured data.",
                          ][idx]
                        }
                      </div>
                    </FeatureCard>
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  { text: "Guaranteed Accuracy", delay: 200 },
                  { text: "PDFs, Images", delay: 400 },
                  { text: "OCR + Vision AI", delay: 600 },
                ].map(({ text, delay }, idx) => (
                  <ScrollReveal
                    key={idx}
                    delay={delay}
